...
group.add_argument('-save',default="C:\work\GitHubLinear_Model\liner\data", help="save a model to path")

group = parser.add_argument_group('train')
group.add_argument('-steps', default=10000,help="train all steps")
group.add_argument('-log_step', default=500,help="train all steps")
